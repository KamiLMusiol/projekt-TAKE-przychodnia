...
### Pobieranie 
W środowisku (np. STS / Eclipse): Wybierasz File -> Import -> Existing Gradle Project. IDE samo przeczyta plik build.gradle, pobierze brakujące biblioteki i odtworzy swoją lokalną konfigurację.
